import{Cn as kI,Er as yc,H as Lt$1,In as ne,Mn as nA,Ot as Z,Pn as nD,S as Ep,Tr as yD,U as M,Xt as da,Y as PI,Yt as dA,Zn as rE,a as $v,et as Qn,hn as ho,in as fA,k as Ic,kn as lp,lr as th,nr as sE,s as AI,sn as fl,sr as tD,v as E,vr as vp,zt as ao}from"./chunk-5XvVQiy2.js";import{i as w}from"./chunk-JltcrRJr.js";import{i as C,p as Jt,w as h,x as Ze}from"./chunk-BDr1J6Tf.js";import{t as I}from"./chunk--TR0RrN-.js";import{t as n}from"./chunk-9GOaJjbF.js";import{i as W,n as R,r as Te,t as B}from"./chunk-DYZRRrgF.js";var it={capture:!0};var mt=[`focus`,`mousedown`,`mouseenter`,`touchstart`];var z=`mat-ripple-loader-uninitialized`;var P=`mat-ripple-loader-class-name`;var X=`mat-ripple-loader-centered`;var k=`mat-ripple-loader-disabled`;var at=(()=>{class a{_document=E(Qn);_animationsDisabled=Jt();_globalRippleOptions=E(W,{optional:!0});_platform=E(h);_ngZone=E(Z);_injector=E(ne);_eventCleanups;_hosts=new Map;constructor(){let t=E(ao).createRenderer(null,null);this._eventCleanups=this._ngZone.runOutsideAngular(()=>mt.map(n=>t.listen(this._document,n,this._onInteraction,it)))}ngOnDestroy(){let t=this._hosts.keys();for(let n of t)this.destroyRipple(n);this._eventCleanups.forEach(n=>n())}configureRipple(t,n){t.setAttribute(z,this._globalRippleOptions?.namespace??``),(n.className||!t.hasAttribute(P))&&t.setAttribute(P,n.className||``),n.centered&&t.setAttribute(X,``),n.disabled&&t.setAttribute(k,``)}setDisabled(t,n){let e=this._hosts.get(t);e?(e.target.rippleDisabled=n,!n&&!e.hasSetUpEvents&&(e.hasSetUpEvents=!0,e.renderer.setupTriggerEvents(t))):n?t.setAttribute(k,``):t.removeAttribute(k)}_onInteraction=t=>{let n=C(t);if(n instanceof HTMLElement){let e=n.closest(`[${z}="${this._globalRippleOptions?.namespace??``}"]`);e&&this._createRipple(e)}};_createRipple(t){if(!this._document||this._hosts.has(t))return;t.querySelector(`.mat-ripple`)?.remove();let n=this._document.createElement(`span`);n.classList.add(`mat-ripple`,t.getAttribute(P)),t.append(n);let e=this._globalRippleOptions,m=this._animationsDisabled?0:e?.animation?.enterDuration??B.enterDuration,r=this._animationsDisabled?0:e?.animation?.exitDuration??B.exitDuration,o={rippleDisabled:this._animationsDisabled||e?.disabled||t.hasAttribute(k),rippleConfig:{centered:t.hasAttribute(X),terminateOnPointerUp:e?.terminateOnPointerUp,animation:{enterDuration:m,exitDuration:r}}},I=new R(o,this._ngZone,n,this._platform,this._injector),M=!o.rippleDisabled;M&&I.setupTriggerEvents(t),this._hosts.set(t,{target:o,renderer:I,hasSetUpEvents:M}),t.removeAttribute(z)}destroyRipple(t){let n=this._hosts.get(t);n&&(n.renderer._removeTriggerEvents(),this._hosts.delete(t))}static ɵfac=function(n){return new(n||a)};static ɵprov=Lt$1({token:a,factory:a.ɵfac})}return a})();var st=new M(`MAT_BUTTON_CONFIG`);function et(a){return a==null?void 0:fA(a)}var x=(()=>{class a{_elementRef=E(ho);_ngZone=E(Z);_animationsDisabled=Jt();_config=E(st,{optional:!0});_focusMonitor=E(Ze);_cleanupClick;_renderer=E(da);_rippleLoader=E(at);_isAnchor;_isFab=!1;color;get disableRipple(){return this._disableRipple}set disableRipple(t){this._disableRipple=t,this._updateRippleDisabled()}_disableRipple=!1;get disabled(){return this._disabled}set disabled(t){this._disabled=t,this._updateRippleDisabled()}_disabled=!1;ariaDisabled;disabledInteractive;tabIndex;set _tabindex(t){this.tabIndex=t}showProgress=nA(!1,{transform:dA});constructor(){E(w).load(Te);let t=this._elementRef.nativeElement;this._isAnchor=t.tagName===`A`,this.disabledInteractive=this._config?.disabledInteractive??!1,this.color=this._config?.color??null,this._rippleLoader?.configureRipple(t,{className:`mat-mdc-button-ripple`})}ngAfterViewInit(){this._focusMonitor.monitor(this._elementRef,!0),this._isAnchor&&this._setupAsAnchor()}ngOnDestroy(){this._cleanupClick?.(),this._focusMonitor.stopMonitoring(this._elementRef),this._rippleLoader?.destroyRipple(this._elementRef.nativeElement)}focus(t=`program`,n){t?this._focusMonitor.focusVia(this._elementRef.nativeElement,t,n):this._elementRef.nativeElement.focus(n)}_getAriaDisabled(){return this.ariaDisabled!=null?this.ariaDisabled:this._isAnchor?this.disabled||null:this.disabled&&this.disabledInteractive?!0:null}_getDisabledAttribute(){return this.disabledInteractive||!this.disabled?null:!0}_updateRippleDisabled(){this._rippleLoader?.setDisabled(this._elementRef.nativeElement,this.disableRipple||this.disabled)}_getTabIndex(){return this._isAnchor?this.disabled&&!this.disabledInteractive?-1:this.tabIndex:this.tabIndex}_setupAsAnchor(){this._cleanupClick=this._ngZone.runOutsideAngular(()=>this._renderer.listen(this._elementRef.nativeElement,`click`,t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation())}))}static ɵfac=function(n){return new(n||a)};static ɵdir=PI({type:a,hostAttrs:[1,`mat-mdc-button-base`],hostVars:15,hostBindings:function(n,e){n&2&&(vp(`disabled`,e._getDisabledAttribute())(`aria-disabled`,e._getAriaDisabled())(`tabindex`,e._getTabIndex()),yD(e.color?`mat-`+e.color:``),th(`mat-mdc-button-progress-indicator-shown`,e.showProgress())(`mat-mdc-button-disabled`,e.disabled)(`mat-mdc-button-disabled-interactive`,e.disabledInteractive)(`mat-unthemed`,!e.color)(`_mat-animation-noopable`,e._animationsDisabled))},inputs:{color:`color`,disableRipple:[2,`disableRipple`,`disableRipple`,dA],disabled:[2,`disabled`,`disabled`,dA],ariaDisabled:[2,`aria-disabled`,`ariaDisabled`,dA],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,dA],tabIndex:[2,`tabIndex`,`tabIndex`,et],_tabindex:[2,`tabindex`,`_tabindex`,et],showProgress:[1,`showProgress`]}})}return a})();var dt=(()=>{class a extends x{constructor(){super(),this._rippleLoader.configureRipple(this._elementRef.nativeElement,{centered:!0})}static ɵfac=function(n){return new(n||a)};static ɵcmp=(function(){let t=[`*`,[[``,`progressIndicator`,``]]],n=[`*`,`[progressIndicator]`];function e(m,r){m&1&&(yc(0,`div`,1),nD(1,1),Ic())}return AI({type:a,selectors:[[`button`,`mat-icon-button`,``],[`a`,`mat-icon-button`,``],[`button`,`matIconButton`,``],[`a`,`matIconButton`,``]],hostAttrs:[1,`mdc-icon-button`,`mat-mdc-icon-button`],exportAs:[`matButton`,`matAnchor`],features:[lp],ngContentSelectors:n,decls:5,vars:1,consts:[[1,`mat-mdc-button-persistent-ripple`,`mdc-icon-button__ripple`],[1,`mat-mdc-button-progress-indicator-container`],[1,`mat-focus-indicator`],[1,`mat-mdc-button-touch-target`]],template:function(r,o){r&1&&(tD(t),Ep(0,`span`,0),nD(1),rE(2,e,2,0,`div`,1),Ep(3,`span`,2)(4,`span`,3)),r&2&&($v(2),sE(o.showProgress()?2:-1))},styles:[`.mat-mdc-icon-button {
...
`],encapsulation:2})})()}return a})();function ct(a){return a.hasAttribute(`mat-raised-button`)?`elevated`:a.hasAttribute(`mat-stroked-button`)?`outlined`:a.hasAttribute(`mat-flat-button`)?`filled`:a.hasAttribute(`mat-button`)?`text`:null}var rt=new M(`mat-mdc-fab-default-options`,{providedIn:`root`,factory:()=>S});var S={color:`accent`};var Tt=(()=>{class a extends x{_options=E(rt,{optional:!0});_isFab=!0;extended=!1;constructor(){super(),this._options=this._options||S,this.color=this._options.color||S.color}static ɵfac=function(n){return new(n||a)};static ɵcmp=(function(){let t=[[[``,8,`material-icons`,3,`iconPositionEnd`,``],[`mat-icon`,3,`iconPositionEnd`,``],[``,`matButtonIcon`,``,3,`iconPositionEnd`,``],[``,8,`material-symbols-outlined`,3,`iconPositionEnd`,``],[``,8,`material-symbols-rounded`,3,`iconPositionEnd`,``],[``,8,`material-symbols-sharp`,3,`iconPositionEnd`,``]],`*`,[[``,`iconPositionEnd`,``,8,`material-icons`],[`mat-icon`,`iconPositionEnd`,``],[``,`matButtonIcon`,``,`iconPositionEnd`,``],[``,`iconPositionEnd`,``,8,`material-symbols-outlined`],[``,`iconPositionEnd`,``,8,`material-symbols-rounded`],[``,`iconPositionEnd`,``,8,`material-symbols-sharp`]],[[``,`progressIndicator`,``]]],n=[`.material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd]), .material-symbols-outlined:not([iconPositionEnd]), .material-symbols-rounded:not([iconPositionEnd]), .material-symbols-sharp:not([iconPositionEnd])`,`*`,`.material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd], .material-symbols-outlined[iconPositionEnd], .material-symbols-rounded[iconPositionEnd], .material-symbols-sharp[iconPositionEnd]`,`[progressIndicator]`];function e(m,r){m&1&&(yc(0,`div`,2),nD(1,3),Ic())}return AI({type:a,selectors:[[`button`,`mat-fab`,``],[`a`,`mat-fab`,``],[`button`,`matFab`,``],[`a`,`matFab`,``]],hostAttrs:[1,`mdc-fab`,`mat-mdc-fab-base`,`mat-mdc-fab`],hostVars:4,hostBindings:function(r,o){r&2&&th(`mdc-fab--extended`,o.extended)(`mat-mdc-extended-fab`,o.extended)},inputs:{extended:[2,`extended`,`extended`,dA]},exportAs:[`matButton`,`matAnchor`],features:[lp],ngContentSelectors:n,decls:8,vars:5,consts:[[1,`mat-mdc-button-persistent-ripple`],[1,`mdc-button__label`],[1,`mat-mdc-button-progress-indicator-container`],[1,`mat-focus-indicator`],[1,`mat-mdc-button-touch-target`]],template:function(r,o){r&1&&(tD(t),Ep(0,`span`,0),nD(1),yc(2,`span`,1),nD(3,1),Ic(),nD(4,2),rE(5,e,2,0,`div`,2),Ep(6,`span`,3)(7,`span`,4)),r&2&&(th(`mdc-button__ripple`,!o._isFab)(`mdc-fab__ripple`,o._isFab),$v(5),sE(o.showProgress()?5:-1))},styles:[`.mat-mdc-fab-base {
  -webkit-user-select: none;
  user-select: none;
  position: relative;
  display: inline-flex;
...
`],encapsulation:2})})()}return a})();var Ot=(()=>{class a extends x{_options=E(rt,{optional:!0});_isFab=!0;constructor(){super(),this._options=this._options||S,this.color=this._options.color||S.color}static ɵfac=function(n){return new(n||a)};static ɵcmp=(function(){let t=[[[``,8,`material-icons`,3,`iconPositionEnd`,``],[`mat-icon`,3,`iconPositionEnd`,``],[``,`matButtonIcon`,``,3,`iconPositionEnd`,``],[``,8,`material-symbols-outlined`,3,`iconPositionEnd`,``],[``,8,`material-symbols-rounded`,3,`iconPositionEnd`,``],[``,8,`material-symbols-sharp`,3,`iconPositionEnd`,``]],`*`,[[``,`iconPositionEnd`,``,8,`material-icons`],[`mat-icon`,`iconPositionEnd`,``],[``,`matButtonIcon`,``,`iconPositionEnd`,``],[``,`iconPositionEnd`,``,8,`material-symbols-outlined`],[``,`iconPositionEnd`,``,8,`material-symbols-rounded`],[``,`iconPositionEnd`,``,8,`material-symbols-sharp`]],[[``,`progressIndicator`,``]]],n=[`.material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd]), .material-symbols-outlined:not([iconPositionEnd]), .material-symbols-rounded:not([iconPositionEnd]), .material-symbols-sharp:not([iconPositionEnd])`,`*`,`.material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd], .material-symbols-outlined[iconPositionEnd], .material-symbols-rounded[iconPositionEnd], .material-symbols-sharp[iconPositionEnd]`,`[progressIndicator]`];function e(m,r){m&1&&(yc(0,`div`,2),nD(1,3),Ic())}return AI({type:a,selectors:[[`button`,`mat-mini-fab`,``],[`a`,`mat-mini-fab`,``],[`button`,`matMiniFab`,``],[`a`,`matMiniFab`,``]],hostAttrs:[1,`mdc-fab`,`mat-mdc-fab-base`,`mdc-fab--mini`,`mat-mdc-mini-fab`],exportAs:[`matButton`,`matAnchor`],features:[lp],ngContentSelectors:n,decls:8,vars:5,consts:[[1,`mat-mdc-button-persistent-ripple`],[1,`mdc-button__label`],[1,`mat-mdc-button-progress-indicator-container`],[1,`mat-focus-indicator`],[1,`mat-mdc-button-touch-target`]],template:function(r,o){r&1&&(tD(t),Ep(0,`span`,0),nD(1),yc(2,`span`,1),nD(3,1),Ic(),nD(4,2),rE(5,e,2,0,`div`,2),Ep(6,`span`,3)(7,`span`,4)),r&2&&(th(`mdc-button__ripple`,!o._isFab)(`mdc-fab__ripple`,o._isFab),$v(5),sE(o.showProgress()?5:-1))},styles:[`.mat-mdc-fab-base {
  -webkit-user-select: none;
  user-select: none;
  position: relative;
  display: inline-flex;
...
`],encapsulation:2})})()}return a})();var Lt=(()=>{class a{static ɵfac=function(n){return new(n||a)};static ɵmod=kI({type:a});static ɵinj=fl({imports:[n,I]})}return a})();export{dt as a,at as i,Ot as n,jt as o,Tt as r,Lt as t};