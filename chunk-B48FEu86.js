import{Cn as kI,E as Gp,Ft as aD,G as Mp,Gn as qg,Kn as ql,Mt as Zp,Or as yp,Pn as nD,Tr as yD,U as M,Wt as cA,X as Pe,Xn as rD,Yt as dA,Zn as rE,a as $v,gr as vc,hn as ho,i as $r,in as fA,j as Ip,lr as th,nr as sE,ot as Sh,pt as Uo,s as AI,sn as fl,sr as tD,t as $D,v as E,vn as iD,vr as vp}from"./chunk-5XvVQiy2.js";import{i as w}from"./chunk-JltcrRJr.js";import{O as le,p as Jt,x as Ze}from"./chunk-BDr1J6Tf.js";import{t as I}from"./chunk--TR0RrN-.js";import{a as be,r as Te}from"./chunk-DYZRRrgF.js";import{O as g}from"./main-L7MY4SSX.js";import{D as x,b as m}from"./chunk-DZq9hBzd.js";var ee=new M(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var u=class{source;checked;constructor(Y,t){this.source=Y,this.checked=t}};var te=(()=>{class a{_elementRef=E(ho);_focusMonitor=E(Ze);_changeDetectorRef=E(cA);defaults=E(ee);_onChange=t=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(t){return new u(this,t)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=Jt();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(t){this._checked=t,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new Pe;toggleChange=new Pe;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){E(w).load(Te);let t=E(new Sh(`tabindex`),{optional:!0}),i=this.defaults;this.tabIndex=t==null?0:parseInt(t)||0,this.color=i.color||`accent`,this.id=this._uniqueId=E(le).getId(`mat-mdc-slide-toggle-`),this.hideIcon=i.hideIcon??!1,this.disabledInteractive=i.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(t=>{t===`keyboard`||t===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):t||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(t){t.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(t){this.checked=!!t}registerOnChange(t){this._onChange=t}registerOnTouched(t){this._onTouched=t}validate(t){return this.required&&t.value!==!0?{required:!0}:null}registerOnValidatorChange(t){this._validatorOnChange=t}setDisabledState(t){this.disabled=t,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new u(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(i){return new(i||a)};static ɵcmp=(function(){let t=[`switch`],i=[`*`];function J(l,n){l&1&&($r(0,`span`,11),ql(),$r(1,`svg`,13),Ip(2,`path`,14),vc(),$r(3,`svg`,15),Ip(4,`path`,16),vc()())}return AI({type:a,selectors:[[`mat-slide-toggle`]],viewQuery:function(n,e){if(n&1&&Zp(t,5),n&2){let o;rD(o=iD())&&(e._switchElement=o.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(n,e){n&2&&(Mp(`id`,e.id),vp(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),yD(e.color?`mat-`+e.color:``),th(`mat-mdc-slide-toggle-focused`,e._focused)(`mat-mdc-slide-toggle-checked`,e.checked)(`mat-slide-toggle-full-width`,e.fullWidth)(`_mat-animation-noopable`,e._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,dA],color:`color`,disabled:[2,`disabled`,`disabled`,dA],fullWidth:[2,`fullWidth`,`fullWidth`,dA],disableRipple:[2,`disableRipple`,`disableRipple`,dA],tabIndex:[2,`tabIndex`,`tabIndex`,l=>l==null?0:fA(l)],checked:[2,`checked`,`checked`,dA],hideIcon:[2,`hideIcon`,`hideIcon`,dA],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,dA]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[$D([{provide:x,useExisting:Uo(()=>a),multi:!0},{provide:m,useExisting:a,multi:!0}]),qg],ngContentSelectors:i,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(n,e){if(n&1&&(tD(),$r(0,`div`,1)(1,`button`,2,0),Gp(`click`,function(){return e._handleClick()}),Ip(3,`div`,3)(4,`span`,4),$r(5,`span`,5)(6,`span`,6)(7,`span`,7),Ip(8,`span`,8),vc(),$r(9,`span`,9),Ip(10,`span`,10),vc(),rE(11,J,5,0,`span`,11),vc()()(),$r(12,`label`,12),Gp(`click`,function(K){return K.stopPropagation()}),nD(13),vc()()),n&2){let o=aD(2);yp(`labelPosition`,e.labelPosition),$v(),th(`mdc-switch--selected`,e.checked)(`mdc-switch--unselected`,!e.checked)(`mdc-switch--checked`,e.checked)(`mdc-switch--disabled`,e.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,e.disabledInteractive),yp(`tabIndex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`disabled`,e.disabled&&!e.disabledInteractive),vp(`id`,e.buttonId)(`name`,e.name)(`aria-label`,e.ariaLabel)(`aria-labelledby`,e._getAriaLabelledBy())(`aria-describedby`,e.ariaDescribedby)(`aria-required`,e.required||null)(`aria-checked`,e.checked)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),$v(9),yp(`matRippleTrigger`,o)(`matRippleDisabled`,e.disableRipple||e.disabled)(`matRippleCentered`,!0),$v(),sE(e.hideIcon?-1:11),$v(),yp(`for`,e.buttonId),vp(`id`,e._labelId)}},dependencies:[be,g],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})})()}return a})();var ve=(()=>{class a{static ɵfac=function(i){return new(i||a)};static ɵmod=kI({type:a});static ɵinj=fl({imports:[te,I]})}return a})();export{ve as n,te as t};