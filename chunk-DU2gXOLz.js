...
`),e+=`
`;})):e+=`No items in order
`,e+=this.generateSeparator(s);let $=t.subTotal||t.subtotal,S=t.tax,y=t.discount,D=t.shippingFee,M=t.serviceFee,T=t.total;return e+=this.COMMANDS.BOLD_ON,e+=`ORDER SUMMARY:
`,e+=this.COMMANDS.BOLD_OFF,$!==void 0&&(e+=`Subtotal:            ${this.formatCurrency($,i)}
`),u&&S&&S>0&&(e+=`Tax:                 ${this.formatCurrency(S,i)}
`),y&&y>0&&(e+=`Discount:           -${this.formatCurrency(y,i)}
...
`,e+=this.generateSeparator(s)),e+=this.COMMANDS.ALIGN_CENTER,(e+=`${P}
...
`}static \u0275fac=function(s){return new(s||a)};static \u0275prov=Q({token:a,factory:a.\u0275fac,providedIn:"root"})};export{R};