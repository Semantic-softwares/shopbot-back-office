import{Cn as kI,E as Gp,Ft as aD,Mt as Zp,Or as yp,Pn as nD,U as M,Wt as cA,X as Pe,Xn as rD,Y as PI,Yt as dA,Zn as rE,a as $v,gr as vc,hn as ho,i as $r,j as Ip,lr as th,nr as sE,ot as Sh,pt as Uo,s as AI,sn as fl,sr as tD,t as $D,tt as Qp,v as E,vn as iD,vr as vp,xr as xe,yt as XE}from"./chunk-5XvVQiy2.js";import{i as w}from"./chunk-JltcrRJr.js";import{L as xe$1,O as le,p as Jt,x as Ze}from"./chunk-BDr1J6Tf.js";import{n as y,t as I}from"./chunk--TR0RrN-.js";import{t as n}from"./chunk-9GOaJjbF.js";import{a as be,r as Te}from"./chunk-DYZRRrgF.js";import{S as m}from"./main-L7MY4SSX.js";import{D as x}from"./chunk-DZq9hBzd.js";import{t as d}from"./chunk-dgoz-vAA.js";var tt=new M(`MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS`,{providedIn:`root`,factory:()=>({hideSingleSelectionIndicator:!1,hideMultipleSelectionIndicator:!1,disabledInteractive:!1})});var et=new M(`MatButtonToggleGroup`);var dt={provide:x,useExisting:Uo(()=>ut),multi:!0};var h=class{source;value;constructor(nt,t){this.source=nt,this.value=t}};var ut=(()=>{class r{_changeDetector=E(cA);_dir=E(y,{optional:!0});_multiple=!1;_disabled=!1;_disabledInteractive=!1;_selectionModel;_rawValue;_controlValueAccessorChangeFn=()=>{};_onTouched=()=>{};_buttonToggles;appearance;get name(){return this._name}set name(t){this._name=t,this._markButtonsForCheck()}_name=E(le).getId(`mat-button-toggle-group-`);vertical=!1;get value(){let t=this._selectionModel?this._selectionModel.selected:[];return this.multiple?t.map(e=>e.value):t[0]?t[0].value:void 0}set value(t){this._setSelectionByValue(t),this.valueChange.emit(this.value)}valueChange=new Pe;get selected(){let t=this._selectionModel?this._selectionModel.selected:[];return this.multiple?t:t[0]||null}get multiple(){return this._multiple}set multiple(t){this._multiple=t,this._markButtonsForCheck()}get disabled(){return this._disabled}set disabled(t){this._disabled=t,this._markButtonsForCheck()}get disabledInteractive(){return this._disabledInteractive}set disabledInteractive(t){this._disabledInteractive=t,this._markButtonsForCheck()}get dir(){return this._dir&&this._dir.value===`rtl`?`rtl`:`ltr`}change=new Pe;get hideSingleSelectionIndicator(){return this._hideSingleSelectionIndicator}set hideSingleSelectionIndicator(t){this._hideSingleSelectionIndicator=t,this._markButtonsForCheck()}_hideSingleSelectionIndicator;get hideMultipleSelectionIndicator(){return this._hideMultipleSelectionIndicator}set hideMultipleSelectionIndicator(t){this._hideMultipleSelectionIndicator=t,this._markButtonsForCheck()}_hideMultipleSelectionIndicator;constructor(){let t=E(tt,{optional:!0});this.appearance=t&&t.appearance?t.appearance:`standard`,this._hideSingleSelectionIndicator=t?.hideSingleSelectionIndicator??!1,this._hideMultipleSelectionIndicator=t?.hideMultipleSelectionIndicator??!1}ngOnInit(){this._selectionModel=new d(this.multiple,void 0,!1)}ngAfterContentInit(){this._selectionModel.select(...this._buttonToggles.filter(t=>t.checked)),this.multiple||this._initializeTabIndex()}writeValue(t){this.value=t,this._changeDetector.markForCheck()}registerOnChange(t){this._controlValueAccessorChangeFn=t}registerOnTouched(t){this._onTouched=t}setDisabledState(t){this.disabled=t}_keydown(t){if(this.multiple||this.disabled||xe$1(t))return;let n=t.target.id,l=this._buttonToggles.toArray().findIndex(a=>a.buttonId===n),o=null;switch(t.keyCode){case 32:case 13:o=this._buttonToggles.get(l)||null;break;case 38:o=this._getNextButton(l,-1);break;case 37:o=this._getNextButton(l,this.dir===`ltr`?-1:1);break;case 40:o=this._getNextButton(l,1);break;case 39:o=this._getNextButton(l,this.dir===`ltr`?1:-1);break;default:return}o&&(t.preventDefault(),o._onButtonClick(),o.focus())}_emitChangeEvent(t){let e=new h(t,this.value);this._rawValue=e.value,this._controlValueAccessorChangeFn(e.value),this.change.emit(e)}_syncButtonToggle(t,e,n=!1,l=!1){!this.multiple&&this.selected&&!t.checked&&(this.selected.checked=!1),this._selectionModel?e?this._selectionModel.select(t):this._selectionModel.deselect(t):l=!0,l?Promise.resolve().then(()=>this._updateModelValue(t,n)):this._updateModelValue(t,n)}_isSelected(t){return this._selectionModel&&this._selectionModel.isSelected(t)}_isPrechecked(t){return typeof this._rawValue>`u`?!1:this.multiple&&Array.isArray(this._rawValue)?this._rawValue.some(e=>t.value!=null&&e===t.value):t.value===this._rawValue}_initializeTabIndex(){if(this._buttonToggles.forEach(t=>{t.tabIndex=-1}),this.selected)this.selected.tabIndex=0;else for(let t=0;t<this._buttonToggles.length;t++){let e=this._buttonToggles.get(t);if(!e.disabled){e.tabIndex=0;break}}}_getNextButton(t,e){let n=this._buttonToggles;for(let l=1;l<=n.length;l++){let o=(t+e*l+n.length)%n.length,a=n.get(o);if(a&&!a.disabled)return a}return null}_setSelectionByValue(t){if(this._rawValue=t,!this._buttonToggles)return;let e=this._buttonToggles.toArray();if(this.multiple&&t?(this._clearSelection(),t.forEach(n=>this._selectValue(n,e))):(this._clearSelection(),this._selectValue(t,e)),!this.multiple&&e.every(n=>n.tabIndex===-1)){for(let n of e)if(!n.disabled){n.tabIndex=0;break}}}_clearSelection(){this._selectionModel.clear(),this._buttonToggles.forEach(t=>{t.checked=!1,this.multiple||(t.tabIndex=-1)})}_selectValue(t,e){for(let n of e)if(n.value===t){n.checked=!0,this._selectionModel.select(n),this.multiple||(n.tabIndex=0);break}}_updateModelValue(t,e){e&&this._emitChangeEvent(t),this.valueChange.emit(this.value)}_markButtonsForCheck(){this._buttonToggles?.forEach(t=>t._markForCheck())}static ɵfac=function(e){return new(e||r)};static ɵdir=PI({type:r,selectors:[[`mat-button-toggle-group`]],contentQueries:function(e,n,l){if(e&1&&Qp(l,at,5),e&2){let o;rD(o=iD())&&(n._buttonToggles=o)}},hostAttrs:[1,`mat-button-toggle-group`],hostVars:6,hostBindings:function(e,n){e&1&&Gp(`keydown`,function(o){return n._keydown(o)}),e&2&&(vp(`role`,n.multiple?`group`:`radiogroup`)(`aria-disabled`,n.disabled),th(`mat-button-toggle-vertical`,n.vertical)(`mat-button-toggle-group-appearance-standard`,n.appearance===`standard`))},inputs:{appearance:`appearance`,name:`name`,vertical:[2,`vertical`,`vertical`,dA],value:`value`,multiple:[2,`multiple`,`multiple`,dA],disabled:[2,`disabled`,`disabled`,dA],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,dA],hideSingleSelectionIndicator:[2,`hideSingleSelectionIndicator`,`hideSingleSelectionIndicator`,dA],hideMultipleSelectionIndicator:[2,`hideMultipleSelectionIndicator`,`hideMultipleSelectionIndicator`,dA]},outputs:{valueChange:`valueChange`,change:`change`},exportAs:[`matButtonToggleGroup`],features:[$D([dt,{provide:et,useExisting:r}])]})}return r})();var at=(()=>{class r{_changeDetectorRef=E(cA);_elementRef=E(ho);_focusMonitor=E(Ze);_idGenerator=E(le);_animationDisabled=Jt();_checked=!1;ariaLabel;ariaLabelledby=null;_buttonElement;buttonToggleGroup;get buttonId(){return`${this.id}-button`}id;name;value;get tabIndex(){return this._tabIndex()}set tabIndex(t){this._tabIndex.set(t)}_tabIndex;disableRipple=!1;get appearance(){return this.buttonToggleGroup?this.buttonToggleGroup.appearance:this._appearance}set appearance(t){this._appearance=t}_appearance;get checked(){return this.buttonToggleGroup?this.buttonToggleGroup._isSelected(this):this._checked}set checked(t){t!==this._checked&&(this._checked=t,this.buttonToggleGroup&&this.buttonToggleGroup._syncButtonToggle(this,this._checked),this._changeDetectorRef.markForCheck())}get disabled(){return this._disabled||this.buttonToggleGroup&&this.buttonToggleGroup.disabled}set disabled(t){this._disabled=t}_disabled=!1;get disabledInteractive(){return this._disabledInteractive||this.buttonToggleGroup!==null&&this.buttonToggleGroup.disabledInteractive}set disabledInteractive(t){this._disabledInteractive=t}_disabledInteractive;change=new Pe;constructor(){E(w).load(Te);let t=E(et,{optional:!0}),e=E(new Sh(`tabindex`),{optional:!0})||``,n=E(tt,{optional:!0});this._tabIndex=xe(parseInt(e)||0),this.buttonToggleGroup=t,this._appearance=n&&n.appearance?n.appearance:`standard`,this._disabledInteractive=n?.disabledInteractive??!1}ngOnInit(){let t=this.buttonToggleGroup;this.id=this.id||this._idGenerator.getId(`mat-button-toggle-`),t&&(t._isPrechecked(this)?this.checked=!0:t._isSelected(this)!==this._checked&&t._syncButtonToggle(this,this._checked))}ngAfterViewInit(){this._animationDisabled||this._elementRef.nativeElement.classList.add(`mat-button-toggle-animations-enabled`),this._focusMonitor.monitor(this._elementRef,!0)}ngOnDestroy(){let t=this.buttonToggleGroup;this._focusMonitor.stopMonitoring(this._elementRef),t&&t._isSelected(this)&&t._syncButtonToggle(this,!1,!1,!0)}focus(t){this._buttonElement.nativeElement.focus(t)}_onButtonClick(){if(this.disabled)return;let t=this.isSingleSelector()?!0:!this._checked;if(t!==this._checked&&(this._checked=t,this.buttonToggleGroup&&(this.buttonToggleGroup._syncButtonToggle(this,this._checked,!0),this.buttonToggleGroup._onTouched())),this.isSingleSelector()){let e=this.buttonToggleGroup._buttonToggles.find(n=>n.tabIndex===0);e&&(e.tabIndex=-1),this.tabIndex=0}this.change.emit(new h(this,this.value))}_markForCheck(){this._changeDetectorRef.markForCheck()}_getButtonName(){return this.isSingleSelector()?this.buttonToggleGroup.name:this.name||null}isSingleSelector(){return this.buttonToggleGroup&&!this.buttonToggleGroup.multiple}static ɵfac=function(e){return new(e||r)};static ɵcmp=(function(){let t=[`button`],e=[`*`];function n(l,o){if(l&1&&($r(0,`div`,2),Ip(1,`mat-pseudo-checkbox`,6),vc()),l&2){let a=XE();$v(),yp(`disabled`,a.disabled)}}return AI({type:r,selectors:[[`mat-button-toggle`]],viewQuery:function(o,a){if(o&1&&Zp(t,5),o&2){let s;rD(s=iD())&&(a._buttonElement=s.first)}},hostAttrs:[`role`,`presentation`,1,`mat-button-toggle`],hostVars:14,hostBindings:function(o,a){o&1&&Gp(`focus`,function(){return a.focus()}),o&2&&(vp(`aria-label`,null)(`aria-labelledby`,null)(`id`,a.id)(`name`,null),th(`mat-button-toggle-standalone`,!a.buttonToggleGroup)(`mat-button-toggle-checked`,a.checked)(`mat-button-toggle-disabled`,a.disabled)(`mat-button-toggle-disabled-interactive`,a.disabledInteractive)(`mat-button-toggle-appearance-standard`,a.appearance===`standard`))},inputs:{ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],id:`id`,name:`name`,value:`value`,tabIndex:`tabIndex`,disableRipple:[2,`disableRipple`,`disableRipple`,dA],appearance:`appearance`,checked:[2,`checked`,`checked`,dA],disabled:[2,`disabled`,`disabled`,dA],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,dA]},outputs:{change:`change`},exportAs:[`matButtonToggle`],ngContentSelectors:e,decls:7,vars:13,consts:[[`button`,``],[`type`,`button`,1,`mat-button-toggle-button`,`mat-focus-indicator`,3,`click`,`id`,`disabled`],[1,`mat-button-toggle-checkbox-wrapper`],[1,`mat-button-toggle-label-content`],[1,`mat-button-toggle-focus-overlay`],[`matRipple`,``,1,`mat-button-toggle-ripple`,3,`matRippleTrigger`,`matRippleDisabled`],[`state`,`checked`,`aria-hidden`,`true`,`appearance`,`minimal`,3,`disabled`]],template:function(o,a){if(o&1&&(tD(),$r(0,`button`,1,0),Gp(`click`,function(){return a._onButtonClick()}),rE(2,n,2,1,`div`,2),$r(3,`span`,3),nD(4),vc()(),Ip(5,`span`,4)(6,`span`,5)),o&2){let s=aD(1);yp(`id`,a.buttonId)(`disabled`,a.disabled&&!a.disabledInteractive||null),vp(`role`,a.isSingleSelector()?`radio`:`button`)(`tabindex`,a.disabled&&!a.disabledInteractive?-1:a.tabIndex)(`aria-pressed`,a.isSingleSelector()?null:a.checked)(`aria-checked`,a.isSingleSelector()?a.checked:null)(`name`,a._getButtonName())(`aria-label`,a.ariaLabel)(`aria-labelledby`,a.ariaLabelledby)(`aria-disabled`,a.disabled&&a.disabledInteractive?`true`:null),$v(2),sE(a.buttonToggleGroup&&(!a.buttonToggleGroup.multiple&&!a.buttonToggleGroup.hideSingleSelectionIndicator||a.buttonToggleGroup.multiple&&!a.buttonToggleGroup.hideMultipleSelectionIndicator)?2:-1),$v(4),yp(`matRippleTrigger`,s)(`matRippleDisabled`,a.disableRipple||a.disabled)}},dependencies:[be,m],styles:[`.mat-button-toggle-standalone,
...
`],encapsulation:2})})()}return r})();var Et=(()=>{class r{static ɵfac=function(e){return new(e||r)};static ɵmod=kI({type:r});static ɵinj=fl({imports:[n,at,I]})}return r})();export{at as n,ut as r,Et as t};